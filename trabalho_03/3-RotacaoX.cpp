// para compilar: g++ 3-RotacaoX.cpp -o 3-RotacaoX -lGL -lGLU -lglut && ./3-RotacaoX
...
void Desenha(void) 
{
    ...
    // Aplica a rotacao de 30 graus no eixo X sobre a modelview atual
